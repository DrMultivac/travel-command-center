...
2. **Create the Notion database.** Follow
   [`templates/notion-database-spec.md`](templates/notion-database-spec.md).
   Fifteen minutes, one database, no template gallery required.
...
4. **Fill in Section 0.** The skill has a standing-facts block: your ticket name,
   KTN, loyalty numbers, seat rules, hard calendar blackouts, and card-to-entity
   mapping. This is the personalization layer; the skill is generic until you
   fill it in.
